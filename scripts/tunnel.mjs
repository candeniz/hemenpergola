...
const WARNING = [
  ...
  '',
  'DEMO PAROLALARI 1234 ve bunlardan biri YONETIM PANELI admini',
  '(admin@dikont.com). Tunel acikken o panel internette. Adresin',
  'rastgele olmasi guvenlik degildir - is bitince kapat.',
  '',
