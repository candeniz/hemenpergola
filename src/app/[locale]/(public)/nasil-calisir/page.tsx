...
/** CMS route 'nasil-calisir' — task 8.3. Thin by design: the CMS is the page. */
...
export async function generateMetadata({
  ...
  const page = await loadContentPage('nasil-calisir', locale)
  return {
    ...(page === null ? {} : { title: page.title }),
    alternates: { canonical: absoluteUrl(localePath(locale, '/nasil-calisir')) },
  }
}
