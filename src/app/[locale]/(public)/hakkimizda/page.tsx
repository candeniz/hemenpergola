...
/** CMS route 'hakkimizda' — task 8.3. Thin by design: the CMS is the page. */
...
export async function generateMetadata({
  ...
  const page = await loadContentPage('hakkimizda', locale)
  return {
    ...(page === null ? {} : { title: page.title }),
    alternates: { canonical: absoluteUrl(localePath(locale, '/hakkimizda')) },
  }
}
